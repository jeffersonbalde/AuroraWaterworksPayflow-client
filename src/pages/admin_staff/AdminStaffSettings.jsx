// src/pages/admin_staff/AdminStaffSettings.jsx - UPDATED TO MATCH CLIENT STYLING
...
const AdminStaffSettings = () => {
  ...
  // Form states - Admin/Staff specific fields
          ...
          <div className="card border-0 shadow-sm h-100">
            ...
            <div className="card-body p-3">
              <div className="d-flex flex-column gap-2">
                ...
                {/* Preferences Tab */}
                <button
                  className={`btn text-start p-3 d-flex align-items-center border-0 position-relative overflow-hidden ${activeTab === 'preferences' ? 'active' : ''}`}
                  onClick={() => handleTabChange('preferences')}
                  style={{
                    background: activeTab === 'preferences' 
                      ? 'linear-gradient(135deg, #2d5a27 0%, #3a6f32 100%)'
                      : '#f8f9fa',
                    border: activeTab === 'preferences' ? 'none' : '1px solid #dee2e6',
                    borderRadius: "8px",
                ...
                >
                  <div className="rounded-circle d-flex align-items-center justify-content-center me-3 flex-shrink-0"
                    style={{
                      width: "36px",
                      height: "36px",
                      background: activeTab === 'preferences' ? 'rgba(255, 255, 255, 0.2)' : 'linear-gradient(135deg, #8B4513 0%, #A0522D 100%)',
                      color: activeTab === 'preferences' ? 'white' : 'white',
                    }}
                  >
                    <FaSlidersH size={16} />
                  </div>
                  <div className="text-start">
                    <div className="fw-semibold" style={{ fontSize: '0.9rem' }}>Preferences</div>
                    <small style={{ opacity: activeTab === 'preferences' ? 0.9 : 0.7, fontSize: '0.75rem' }}>
                      System preferences
                    </small>
                  </div>
                </button>
                ...
                <form onSubmit={handleAccountUpdate}>
                  <div className="row g-3">
                    ...
                    <div className="col-12 col-md-6">
                      ...
                      <div className="input-group">
                        ...
                        <input
                          type="text"
                          name="position"
                          className={`form-control border-start-0 ps-2 fw-semibold ${formErrors.position ? 'is-invalid' : ''}`}
                          value={accountForm.position}
                          onChange={handleAccountInputChange}
                          placeholder="Enter your position"
                        />
                      </div>
                      {formErrors.position && <div className="invalid-feedback d-block small mt-1">{formErrors.position[0]}</div>}
                    </div>
                    ...
                    <div className="col-12 col-md-6">
                      ...
                      <div className="input-group">
                        <span className="input-group-text bg-transparent border-end-0">
                          <FaShieldAlt className="text-muted" size={16} />
                        </span>
                        <input
                          type="text"
                      ...
                      <div className="form-text small mt-1">Your system role (cannot be changed)</div>
                    </div>
                ...
                <div className="row g-3">
                  ...
                  <div className="col-12 col-md-6">
                    ...
                    <select 
                      ...
                      onChange={(e) => handlePreferenceChange('dashboard_refresh_rate', e.target.value)}
                    >
...
export default AdminStaffSettings;