...
const AdminSettings = () => {
  ...
  // Theme matching BarangaySettings
  const theme = {
    primary: "#2d5a27",
    primaryDark: "#1f451c",
    primaryLight: "#3a6f32",
  ...
  const fetchAuthorizationCodes = async () => {
    ...
    try {
      const response = await fetch(
        `${import.meta.env.VITE_LARAVEL_API}/admin/authorization-codes`,
        {
          headers: {
  ...
  const handlePasswordChange = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        `${import.meta.env.VITE_LARAVEL_API}/profile`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
  ...
  return (
    <div className="container-fluid px-4 py-3 fadeIn">
      {/* Header - MATCHING BARANGAY SETTINGS STYLING */}
      ...
      <div className="row g-3">
        {/* Sidebar Navigation - MATCHING BARANGAY SETTINGS STYLING */}
          ...
          {activeTab === "password" && (
            ...
            >
              ...
              <div className="card-body p-3">
                ...
                >
                  <strong>Administrator Note:</strong> As a system
                  administrator, you can only change your password. Personal
                  information modifications are restricted for security reasons.
                </div>
          ...
          {activeTab === "auth-codes" && (
            ...
            >
              ...
              <div className="card-body p-3">
                ...
                >
                  <strong>Note:</strong> Authorization codes are required when
                  restating amounts in meter readings and billing management.
                  Only active, non-expired codes can be used.
                </div>
