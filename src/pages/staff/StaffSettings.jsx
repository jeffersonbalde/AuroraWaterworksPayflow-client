          ...
          <div className="card border-0 shadow-sm h-100">
            ...
            <div className="card-body p-3">
              <div className="d-flex flex-column gap-2">
                ...
                <button
                  className={`btn text-start p-3 d-flex align-items-center border-0 ${activeTab === 'account' ? 'active' : ''}`}
                ...
                {/* Change Password Tab */}
                <button
                  className={`btn text-start p-3 d-flex align-items-center border-0 ${activeTab === 'password' ? 'active' : ''}`}
                ...
                <form onSubmit={handleAccountUpdate}>
                  <div className="row g-3">
                    ...
                    <div className="col-12 col-md-6">
                      ...
                      <div className="input-group">
                        <span className="input-group-text bg-transparent border-end-0">
                          <FaUserTie className="text-muted" size={16} />
                        </span>
                        <input
                          type="text"
                          name="position"
